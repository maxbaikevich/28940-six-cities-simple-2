...
import OfferController from './modules/offer/offer-contriller.js';
...
import ExeptionFilter from './common/errors/exeption-filter.js';
...
applicationContainer.bind<OfferServiceInteface>(Component.OfferServiceInteface).to(OfferSevice).inSingletonScope();
...
applicationContainer.bind<ControllerInterface>(Component.UserController).to(UserController);
applicationContainer.bind<ControllerInterface>(Component.OfferController).to(OfferController);
applicationContainer.bind<ExeptionFilterInterface>(Component.ExeptionFilterInterface).to(ExeptionFilter);
